  ...
  return (
    <section ref={ref} className="mb-2 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id="home">
      ...
      >
        ...
        <a className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10" href="/Pedro_Resume.pdf" download>
